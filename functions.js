    ...
    .done(function (data) {
        ...
        $.each(data, function (key, row) {
            ...
            if (row.hashrate != null) {
                ...
                document.getElementById("gpu").innerHTML = document.getElementById("gpu").innerHTML + "<tr><th>Totals (" + row.type + ")</th><th id='tot10'>" + Number(row.hashrate[0]).toFixed(1) + "</th><th id='tot60'>" + Number(row.hashrate[1]).toFixed(1) + "</th><th id='tot900'>" + Number(row.hashrate[2]).toFixed(1);
                +"</th></tr>";
            }
